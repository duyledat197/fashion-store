...
func request_UploadService_Upload_0(ctx context.Context, marshaler runtime.Marshaler, client UploadServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterUploadServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server UploadServiceServer) error {
	...
	mux.Handle("POST", pattern_UploadService_Upload_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterUploadServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client UploadServiceClient) error {
	...
	mux.Handle("POST", pattern_UploadService_Upload_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/pb.UploadService/Upload", runtime.WithHTTPPathPattern("/v1/files/upload"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_UploadService_Upload_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		...
		forward_UploadService_Upload_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_UploadService_Upload_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "files", "upload"}, ""))
)

var (
	forward_UploadService_Upload_0 = runtime.ForwardResponseMessage
)
