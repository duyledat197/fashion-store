...
// IncrementForgotPassword provides a mock function with given fields: ctx, email
func (_m *UserCacheRepository) IncrementForgotPassword(ctx context.Context, email string) (int64, error) {
...
// IsExistResetToken provides a mock function with given fields: ctx, email, resetToken
func (_m *UserCacheRepository) IsExistResetToken(ctx context.Context, email string, resetToken string) error {
	ret := _m.Called(ctx, email, resetToken)

	if len(ret) == 0 {
		panic("no return value specified for IsExistResetToken")
	}
...
// StoreResetToken provides a mock function with given fields: ctx, email, resetToken
func (_m *UserCacheRepository) StoreResetToken(ctx context.Context, email string, resetToken string) error {
	ret := _m.Called(ctx, email, resetToken)
